...
![](assets/2021-10-23-14-32-36-image.png)

Name static library project

![](assets/2021-10-23-14-33-51-image.png)

Default configuration come with C++ project types and setting

![](assets/2021-10-23-14-35-30-image.png)
...
![](assets/2021-10-23-14-45-56-image.png)
...
![](assets/2021-10-23-15-58-07-image.png)

Now we can compile our library

![](assets/2021-10-23-15-59-10-image.png)

![](assets/2021-10-23-15-59-27-image.png)

in debug folder we will see our output

![](assets/2021-10-23-16-00-02-image.png)

now we will add a console application c-sample-app and use our library

![](assets/2021-10-23-16-00-47-image.png)

![](assets/2021-10-23-16-01-06-image.png)
...
![](assets/2021-10-23-16-14-44-image.png)

![](assets/2021-10-23-16-14-53-image.png)

![](assets/2021-10-23-16-15-09-image.png)

![](assets/2021-10-23-16-15-21-image.png)
...
![](assets/2021-10-23-16-16-03-image.png)
...
![](assets/2021-10-23-16-17-54-image.png)

![](assets/2021-10-23-16-19-00-image.png)

![](assets/2021-10-23-16-19-20-image.png)

![](assets/2021-10-23-16-19-29-image.png)
...
![](assets/2021-10-23-16-22-54-image.png)
...
![](assets/2021-10-23-16-29-46-image.png)
...
![](assets/2021-10-23-23-48-33-image.png)
...
![](assets/2021-10-23-23-50-09-image.png)
...
![](assets/2021-10-23-23-51-37-image.png)

![](assets/2021-10-23-23-51-20-image.png)
...
![](assets/2021-10-23-23-54-22-image.png)

![](assets/2021-10-23-23-54-42-image.png)

![](assets/2021-10-23-23-54-08-image.png)

If we set full path for both libraries and headers then we need to set library name for project

**Linker->Input->Additional Dependencies**

![](assets/2021-10-23-23-56-40-image.png)
...
![](assets/2021-10-24-00-15-40-image.png)
...
![](assets/2021-10-24-00-18-38-image.png)

Clear C/C++ -> General -> Additional Include Directories

![](assets/2021-10-24-00-19-20-image.png)

Clear Linker->Input->Additional Dependencies

![](assets/2021-10-24-00-19-51-image.png)
...
![](assets/2021-10-24-12-00-18-image.png)

Configure Platform Toolset to WSL

![](assets/2021-10-24-12-00-47-image.png)

![](assets/2021-10-24-12-01-15-image.png)

Put a breakpoint and run debugger

![](assets/2021-10-24-12-02-48-image.png)
...
![](assets/2021-10-24-12-06-58-image.png)

![](assets/2021-10-24-12-07-16-image.png)
...
![](assets/2021-10-24-00-59-38-image.png)
...
![](assets/2021-10-24-01-01-59-image.png)

You will have default empty class library file

![](assets/2021-10-24-01-03-45-image.png)

In the project you can see .NETcore reference

![](assets/2021-10-24-01-03-55-image.png)

We can build empty class library that generate dll for our application

![](assets/2021-10-24-01-04-06-image.png)

Now we will add Console Application but this will also use .NETCore

Select New Project 

![](assets/2021-10-24-01-04-43-image.png)

Name the project

![](assets/2021-10-24-01-25-44-image.png)

Select .NETCore framework

![](assets/2021-10-24-01-26-00-image.png)
...
![](assets/2021-10-24-01-33-49-image.png)
...
![](assets/2021-10-24-02-04-18-image.png)

If you run csharp-sample-app

you will have the same output

![](assets/2021-10-24-02-04-32-image.png)
...
![](assets/2021-10-24-11-39-03-image.png)

![](assets/2021-10-24-11-39-17-image.png)

![](assets/2021-10-24-02-19-48-image.png)

![](assets/2021-10-24-02-21-55-image.png)

<TODO>

![](assets/2021-10-24-02-24-39-image.png)

![](assets/2021-10-24-02-24-53-image.png)

![](assets/2021-10-24-02-26-15-image.png)

![](assets/2021-10-24-02-26-50-image.png)

![](assets/2021-10-24-02-27-56-image.png)

![](assets/2021-10-24-02-28-27-image.png)

![](assets/2021-10-24-02-29-50-image.png)

![](assets/2021-10-24-02-30-03-image.png)
...
![](assets/2021-10-24-10-17-06-image.png)

![](assets/2021-10-24-10-16-44-image.png)

There is no exe files java runtime environment run class files but we can export this as an executable.

![](assets/2021-10-24-10-19-33-image.png)

Select Java->Runnable JAR File

![](assets/2021-10-24-10-20-33-image.png)

click next and set output path for jar file

![](assets/2021-10-24-10-22-07-image.png)
...
![](assets/2021-10-24-10-28-37-image.png)
...
![](assets/2021-10-24-10-30-21-image.png)

We can found installed and builded JDK for our application from Eclipse setting

![](assets/2021-10-24-10-32-28-image.png)

![](assets/2021-10-24-10-32-57-image.png)

![](assets/2021-10-24-10-33-25-image.png)

![](assets/2021-10-24-10-33-48-image.png)

```batch
C:\Program Files\Java\jdk-16.0.1
```

![](assets/2021-10-24-10-34-26-image.png)

![](assets/2021-10-24-10-34-49-image.png)

Check user settings first

![](assets/2021-10-24-10-35-28-image.png)

![](assets/2021-10-24-10-35-43-image.png)

Check system settings

![](assets/2021-10-24-10-36-14-image.png)

![](assets/2021-10-24-10-36-37-image.png)

we will move up the JDK 16 configuration then command line will run first java 

![](assets/2021-10-24-10-37-22-image.png)

Also in system setting check JAVA_HOME

![](assets/2021-10-24-10-37-50-image.png)
...
![](assets/2021-10-24-10-39-39-image.png)

and now if we enter and run application as follow we will see output

![](assets/2021-10-24-10-40-31-image.png)
...
![](assets/2021-10-24-11-32-00-image.png)

![](assets/2021-10-24-11-32-21-image.png)
...
![](assets/2021-10-24-11-34-18-image.png)

if we click bat file then we will automate command line task for current jar file

![](assets/2021-10-24-11-34-50-image.png)

Now return back to our java library and create another console application that use library functions

![](assets/2021-10-24-14-09-58-image.png)

![](assets/2021-10-24-14-13-53-image.png)

![](assets/2021-10-24-14-19-22-image.png)

you can set libraries in this step from but our library should exported for our solution

![](assets/2021-10-24-14-20-12-image.png)

![](assets/2021-10-24-14-20-26-image.png)

Open Exported jar folder and select

![](assets/2021-10-24-14-20-46-image.png)

Or we can select by Add jar from current workspace

![](assets/2021-10-24-14-22-22-image.png)

![](assets/2021-10-24-14-22-10-image.png)

but in this step I won't add anything I'll add references later

![](assets/2021-10-24-14-23-12-image.png)

we will have the following project

![](assets/2021-10-24-14-24-04-image.png)

lets create a package

![](assets/2021-10-24-14-24-36-image.png)

![](assets/2021-10-24-14-24-54-image.png)

and lets create a main class for our application

![](assets/2021-10-24-14-25-27-image.png)

check create main function

![](assets/2021-10-24-14-26-05-image.png)

![](assets/2021-10-24-14-26-50-image.png)

right click to project and add reference

![](assets/2021-10-24-14-27-51-image.png)

you can enter same configurations from project properties

![](assets/2021-10-24-14-28-35-image.png)

Lets export our library as a JAR file and then add to our classpath

![](assets/2021-10-24-14-30-37-image.png)

Select JAR file

![](assets/2021-10-24-14-30-55-image.png)

![](assets/2021-10-24-14-31-54-image.png)
...
![](assets/2021-10-24-14-32-38-image.png)

![](assets/2021-10-24-14-33-05-image.png)

In the same export folder now we have JavaSampleLib.jar

![](assets/2021-10-24-14-33-54-image.png)

return back to java-sample-app and then add this jar file to our project

Build Path->Add External Archives

![](assets/2021-10-24-14-34-39-image.png)

you will see its added to reference libraries

![](assets/2021-10-24-14-35-30-image.png)
...
![](assets/2021-10-24-14-38-18-image.png)

Lets export this application with its dependent library

![](assets/2021-10-24-14-39-05-image.png)

Select runnable jar

![](assets/2021-10-24-14-39-23-image.png)

Set Launch configuration and Export destination

![](assets/2021-10-24-14-40-10-image.png)
...
![](assets/2021-10-24-14-42-02-image.png)

and we can run with command line

![](assets/2021-10-24-14-42-26-image.png)
...
![](assets/2021-10-25-02-41-08-image.png)

select Native Unit Test

![](assets/2021-10-25-02-41-46-image.png)

set project path and name

![](assets/2021-10-25-02-42-35-image.png)

![](assets/2021-10-25-02-42-54-image.png)

add library project from references

![](assets/2021-10-25-02-44-13-image.png)

![](assets/2021-10-25-02-44-31-image.png)
...
![](assets/2021-10-25-02-54-23-image.png)
...
![](assets/2021-10-25-01-28-20-image.png)

set project framework and path

![](assets/2021-10-25-01-27-50-image.png)

Create library functions

![](assets/2021-10-25-01-31-06-image.png)
...
![](assets/2021-10-25-01-32-52-image.png)

press OK

![](assets/2021-10-25-01-33-16-image.png)
...
![](assets/2021-10-25-01-43-14-image.png)

you will code coverage and entered or passed branches

![](assets/2021-10-25-01-43-45-image.png)
...
![](assets/2021-10-24-18-01-34-image.png)

![](assets/2021-10-24-18-02-18-image.png)

![](assets/2021-10-24-18-02-35-image.png)

![](assets/2021-10-24-18-03-05-image.png)

Add project reference

![](assets/2021-10-24-18-03-40-image.png)

![](assets/2021-10-24-18-03-56-image.png)
...
![](assets/2021-10-24-18-17-57-image.png)

or you can run from project

![](assets/2021-10-24-18-21-31-image.png)
...
![](assets/2021-10-24-22-33-23-image.png)

