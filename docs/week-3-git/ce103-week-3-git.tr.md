...
Download [DOC](ce103-week-3-git.tr.md_doc.pdf), [SLIDE](ce103-week-3-git.tr.md_slide.pdf), [PPTX](ce103-week-3-git.tr.md_slide.pptx)

<iframe width=700, height=500 frameBorder=0 src="../ce103-week-3-git.tr.md_slide.html"></iframe>
